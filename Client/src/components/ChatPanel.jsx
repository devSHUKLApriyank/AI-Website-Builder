      ...
      <div className='flex-1 overflow-y-auto p-3 space-y-3 hide-scrollbar'>
        {messages.length === 0 && (
          <div className='flex items-center justify-center h-full'>
            <p className='flex items-center justify-center h-full'>Ask AI to modify your website</p>
          </div>
        )}
          ...
          <div key={i}>
            <div className='flex gap-2.5 items-start'>
              ...
              <div className='flex-1 min-w-0'>
                <p className='text-xs font-medium text-zinc-500 mg-1 uppercase tracking-wider'>
